...
/**
 * App that forwards {@link Intent#ACTION_MANAGE_APP_PERMISSIONS} or
 * {@link Intent#ACTION_MANAGE_PERMISSION_APPS} to the fragments handling them.
 */
public final class DetailManagePermissionsActivity extends FragmentActivity {
    private static final String LOG_TAG = DetailManagePermissionsActivity.class.getSimpleName();
